...
```bash
git remote add encore encore://erp-lite-system-tp92
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/erp-lite-system-tp92/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/erp-lite-system-tp92/settings/integrations/github)
